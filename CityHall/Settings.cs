...
namespace CityHall
{
    public class Settings
    {
         ...
         */
        public static Task<ISettings> FromUrl(string url, string user, string password)
        {
         ...
         */
        public static Task<ISettings> Create(string url=null, string user=null, string password=null)
        {
            throw new NotImplementedException();
        }
    }
